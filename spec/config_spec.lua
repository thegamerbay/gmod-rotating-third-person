...
describe("Rotating Third Person Configs", function()
    ...
    it("should register all RTP_VARS", function()
        ...
        assert.is_false(RTP_VARS.SMART_SCOPE:GetBool())
        ...
        assert.are.equal(255, RTP_VARS.CROSSHAIR_R:GetInt())
        assert.are.equal(230, RTP_VARS.CROSSHAIR_G:GetInt())
        assert.are.equal(0, RTP_VARS.CROSSHAIR_B:GetInt())
        assert.are.equal(240, RTP_VARS.CROSSHAIR_A:GetInt())
        assert.are.equal(3, RTP_VARS.CROSSHAIR_SIZE:GetInt())
    end)
