...
* **ความราบรื่นในการหมุนตอนเล็ง:** กำหนดค่าความราบรื่นในการที่ตัวละครจะหมุนลําตัวเพื่อหันตามกล้องเมื่อคุณทำการเล็งอาวุธอย่างแม่นยำ
...
* **โหมดไฮบริด (Smart Scope):** ใช้งานร่วมกับฐานอาวุธ (Weapon bases) อย่าง TFA หรือ CW 2.0 ได้อย่างไร้ปัญหา กล้องจะเปลี่ยนเป็นมุมมองบุคคลที่หนึ่งโดยอัตโนมัติเมื่อคุณพยายามเล็ง
...
* **ทรานซิชันกล้องแบบภาพยนตร์ (Cinematic Camera Transition):** เพลิดเพลินกับการเคลื่อนที่ของกล้องที่ลื่นไหลเมื่อสลับระหว่างมุมมองบุคคลที่หนึ่งและบุคคลที่สาม ปรับแต่งความเร็วได้ตามต้องการ!
...
| `rtp_aim_rotation_speed` | ความราบรื่นในการหมุนของตัวละครขณะเล็ง (1 = ช้า, 20 = เร็ว) | `10` |
| `rtp_transition_speed` | ความเร็วของการเคลื่อนที่กล้องแบบภาพยนตร์ ตั้งค่าเป็น 0 เพื่อการสลับในทันที | `4` |
