...
* **智能瞄具集成：** 与 TFA 或 CW 2.0 等武器库一起游玩而不会产生冲突。当使用高倍狙击镜瞄准时，摄像机会无缝自动切换到第一人称视角。
...
5. 直接通过复选框启用或禁用诸如切换瞄准、智能瞄具和 Y轴反转等新特性。
...
| `rtp_smart_scope` | 放大瞄准时（FOV < 阈值）自动禁用第三人称。 | `1` |
| `rtp_smart_scope_threshold` | 设置智能瞄具自动切换到第一人称的 FOV 阈值。 | `50` |
